...
.setColor('GREEN')
.setDescription('Başvurunuz Gönderildi En Kısa Sürede <#786878364731703306> Kanalından Cevap Vereceğiz!')
...
client.channels.cache.get('786878364731703306').send(embed2); 
};
exports.conf = {
    enabled: true,
    guildOnly: true,
